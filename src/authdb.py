...
class CredentialDB:
    def __init__(self):
        ...
        self.conn.commit()
        self.conn.execute("""CREATE TABLE IF NOT EXISTS credential (username TEXT PRIMARY KEY UNIQUE, hashedPw BLOB NOT NULL UNIQUE, token TEXT DEFAULT NULL, tokenTime FLOAT DEFAULT NULL)""")
